...
### 철학
브랜드 컬러(#E8547A)는 ROOMTING의 정체성을 표현하는 색이지만,
...
- `theme.css`의 `--danger`가 `--pink`와 동일 값(`#E8547A`)을 사용 중. 브랜드 컬러 롤아웃(`#E8547A→#F05A7E`) 시 `--danger`를 분리(후보 `#DC2626`) 검토, 실제 변경 시 문서도 함께 업데이트한다.
